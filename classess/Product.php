...
class Product
{
	...
	public function productInsert($data, $file)
	{
		...
		if ($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" || $file_name == "" || $type == "") {
			...
			$query = "INSERT INTO tbl_product(productName,catId,brandId,body, quantity, price,image,type) VALUES('$productName','$catId','$brandId','$body', '$quantity','$price','$uploaded_image','$type') ";
...
ORDER BY p.productId DESC";
	...
	public function productUpdate($data, $file, $id)
	{
		...
		if ($productName == "" || $catId == "" || $brandId == "" || $body == "" || $quantity == "" || $price == "" || $type == "") {
...
WHERE p.catId = c.catId AND p.brandId = b.brandId AND p.productId = '$id'";
	...
	public function insertCompareData($cmprid, $cmrId)
	{
		...
		if ($result) {
			...
			$query = "INSERT INTO tbl_compare(cmrId,productId,productName,quantity, price,image)VALUES
	...
	public function saveWishListData($id, $cmrId)
	{
		...
		if ($result) {
			...
			$query = "INSERT INTO tbl_wlist(cmrId,productId,productName,price,image) VALUES('$cmrId','$productId','$productName', '$quantity','$price','$image') ";
			$inserted_row = $this->db->insert($query);
