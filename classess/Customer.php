...
class Customer
{
	...
	public function customerLogin($data)
	{
		...
		if ($result != false) {
			...
			if (isset($_POST['proid'])) {
				header('location:details.php?proid=' . $_POST['proid']);
			} else {
	...
	public function customerUpdate($data, $cmrId)
	{
		...
		if ($name == "" || $address == "" || $country == "" || $phone == "" || $email == "") {
			...
			$query = "INSERT INTO tbl_customer(name,address,city,country,zip,phone,email) VALUES('$name','$address','$country','$phone','$email',)";
